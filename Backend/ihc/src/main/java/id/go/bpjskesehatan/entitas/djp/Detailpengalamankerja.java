...
/**
 * The persistent class for the DETAILPENGALAMANKERJA database table.
 * 
 */
@JsonInclude(Include.NON_NULL)
@JsonRootName("Detailpengalamankerja")
@Entity
@NamedQuery(name = "Detailpengalamankerja.findAll", query = "SELECT d FROM Detailpengalamankerja d")
