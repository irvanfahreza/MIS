...
/**
 * The persistent class for the STANDARDJP database table.
 * 
 */
@JsonInclude(Include.NON_NULL)
@JsonRootName("standardjp")
@Entity
@NamedQuery(name = "Standardjp.findAll", query = "SELECT s FROM Standardjp s")
public class Standardjp implements Serializable {
