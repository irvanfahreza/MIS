...
/**
 * The persistent class for the DETAILDIMENSIJABATAN database table.
 * 
 */
@JsonInclude(Include.NON_NULL)
@JsonRootName("Detaildimensijabatan")
@Entity
@NamedQuery(name = "Detaildimensijabatan.findAll", query = "SELECT d FROM Detaildimensijabatan d")
public class Detaildimensijabatan implements Serializable {
