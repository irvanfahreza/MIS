...
/**
 * The persistent class for the MASTERNILAIDETAIL database table.
 * 
 */
@JsonInclude(Include.NON_NULL)
@Entity
@NamedQuery(name="Masternilaidetail.findAll", query="SELECT m FROM Masternilaidetail m")
public class Masternilaidetail implements Serializable {
