...
/**
 * The persistent class for the UBKOMPETENSIKOMUNIKASI database table.
 * 
 */
@JsonInclude(Include.NON_NULL)
@Entity
@NamedQuery(name = "Ubkompetensikomunikasi.findAll", query = "SELECT u FROM Ubkompetensikomunikasi u")
public class Ubkompetensikomunikasi implements Serializable {
