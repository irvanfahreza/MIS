...
/**
 * The persistent class for the DETAILALAMAT2HIST database table.
 * 
 */
@Entity
@JsonInclude(Include.NON_NULL)
@JsonRootName("Detailalamat2hist")
@NamedQuery(name = "Detailalamat2hist.findAll", query = "SELECT d FROM Detailalamat2hist d")
public class Detailalamat2hist implements Serializable {
